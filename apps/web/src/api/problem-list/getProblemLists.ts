...
export async function getProblemLists(opt: GetProblemListsOptions = {}): Promise<GetProblemListsResponse> {
	...
	const res = await fetch(`${env.BACKEND_INTERNAL_URL}/api/problem-lists?${qs.stringify(queryParams)}`, {
		method: 'GET',
		headers: {
